...
public class InverseTest extends RootModel {
   ...
   public void addMotionTargets (TrackingController controller) {
      ...
      sources.forEach (s -> {
         ...
         controller.addMotionTarget (s);
      });
      
      // Shank
      controller.addMotionTarget (mkr2);
      controller.addMotionTarget (mkr3);
      }
   ...
   public void createProbes () throws IOException {
      ...
      String filename =
         PathFinder
            .getSourceRelativePath (
               this, "InverseTest/Input/InverseTest_external_forces.txt");
      ...
      filename =
         PathFinder
            .getSourceRelativePath (
               this, "InverseTest/Output/InverseTest_constraint_forces.txt");
   ...
   public void reloadForceProbes () throws IOException {
      if (getInputProbes ().get ("target forces") != null) {
         ...
         String filename =
            PathFinder
               .getSourceRelativePath (
                  this, "InverseTest/Input/InverseTest_target_forces.txt");
   ...
   public void reloadMotionProbes () throws IOException {
      if (getInputProbes ().get ("target positions") != null) {
         ...
         String filename =
            PathFinder
               .getSourceRelativePath (
                  this, "InverseTest/Input/InverseTest_target_positions.txt");
